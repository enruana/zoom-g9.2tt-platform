      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 relative z-10">
        ...
        {authState.isLoading ? (
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <button
              onClick={handleStart}
              className="px-8 py-3 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 rounded-xl font-semibold text-white transition-all shadow-lg shadow-blue-500/25"
            >
              Get Started
            </button>
            ...
            <button
              ...
              className="flex items-center gap-3 px-6 py-3 bg-neutral-800 hover:bg-neutral-700 border border-neutral-700 text-neutral-300 font-medium rounded-xl transition-all"
            >
            ...
            <p className="text-neutral-600 text-xs">
              Sign in to save patches to the cloud
            </p>
            {authState.error && (
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="flex items-center gap-3 bg-neutral-800/50 px-4 py-2 rounded-full border border-neutral-700">
