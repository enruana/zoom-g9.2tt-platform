...
export function Splash() {
  ...
  return (
    <div className="h-screen text-white flex flex-col relative overflow-hidden">
      ...
      {/* Browser Warning - hidden on mobile */}
      {!browserCheck.supported && (
        <div className="hidden md:block bg-yellow-600 text-yellow-100 px-4 py-2 text-center text-sm relative z-10 shrink-0">
      ...
      {/* Footer */}
      <div className="p-2 md:p-4 text-center relative z-10 shrink-0 space-y-1">
        <div className="flex items-center justify-center gap-3 text-neutral-500 text-[10px] md:text-xs">
          <span>Made by <span className="text-neutral-400">enruana</span></span>
          ...
          <span className="text-neutral-700">•</span>
          <a
            href="https://github.com/enruana/zoom-g9.2tt-platform"
            target="_blank"
        ...
        <p className="text-neutral-700 text-[9px] md:text-[10px]">
